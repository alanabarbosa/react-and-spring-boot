insert into person (first_name, last_name, enabled, gender, address) values
		('Alana', 'Barbosa', b'1', 'Female','Rua Osvaldo Fabretti'),
		('Arya', 'Barbosa', b'1', 'Female','Rua Osvaldo'),
		('Son', 'Goku', b'1', 'Male','Dragon City'),
		('Jair', 'Bolsonaro', b'1', 'Male','Rio de Janeiro'),
		('Juju', 'do Pix', b'1', 'Male','Rua do Golpé'),
		('Lula', 'Ladrão', b'1', 'Male','Rua do Golpé'),
		('Uzumaki', 'Naruto', b'1', 'Male','Konoha'),
		('Haddad', 'Taxa humana', b'1', 'Male','Rua do Golpé'),
